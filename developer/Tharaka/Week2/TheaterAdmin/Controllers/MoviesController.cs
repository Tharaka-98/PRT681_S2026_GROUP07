...
namespace TheaterAdmin.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            var theaterDbContext = _context.Movies.Include(m => m.Category);
            return View(await theaterDbContext.ToListAsync());
        }
        ...
        public IActionResult Create()
        {
            ...
            ViewData["Languages"] = new SelectList(Enum.GetValues(typeof(Language)));
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ReleaseDate,Director,ContactEmail,Language,CategoryId")] Movie movie)
        {
            ...
            ViewData["Languages"] = new SelectList(Enum.GetValues(typeof(Language)), movie.Language);
            return View(movie);
        }
